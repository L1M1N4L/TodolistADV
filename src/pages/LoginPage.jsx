      ...
      <div className="w-full lg:w-1/2 flex justify-center items-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Sign in to continue to your Cozy Task Café</p>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#0F0B1F] text-gray-400">Or continue with</span>
            </div>
          </div>
          ...
          <div className="text-center mt-6">
            ...
            <Link to="/signup" className="text-purple-400 hover:text-purple-300 ml-1 font-medium">
              Sign up
            </Link>
          </div>
